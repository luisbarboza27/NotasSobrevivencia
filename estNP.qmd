...
<!-- Otro aspecto a calcular es el tiempo medio de sobrevivencia de este grupo de pacientes. Para ello usamos la función _print_ del paquete _survival_: -->
...
<!-- legend(90, 1, c("Male-68", "Female-68","Male-80", "Female-80"), col=1:4,lty=1) -->
